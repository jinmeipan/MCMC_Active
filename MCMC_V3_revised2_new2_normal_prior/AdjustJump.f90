...
Do i=1,Nlyr
  Call CalcStdDev(ThetaPost(iDz(i),1:iIter),iIter,DzStd(i))
  Call CalcStdDev(ThetaPost(iRho(i),1:iIter),iIter,RhoStd(i))
  Call CalcStdDev(ThetaPost(iD(i),1:iIter),iIter,DStd(i))
  Call CalcStdDev(ThetaPost(iTsnow(i),1:iIter),iIter,TsnowStd(i))
End Do
Call CalcStdDev(ThetaPost(iTsoil,1:iIter),iIter,TsoilStd)
Call CalcStdDev(ThetaPost(iMvS,1:iIter),iIter,MvSStd)
Call CalcStdDev(ThetaPost(iGndSig,1:iIter),iIter,GndSigStd)
Call CalcStdDev(ThetaPost(iP_M,1:iIter),iIter,P_MStd)
Call CalcStdDev(ThetaPost(iP_Q,1:iIter),iIter,P_QStd)
Call CalcStdDev(ThetaPost(iP_SR,1:iIter),iIter,P_SRStd)
